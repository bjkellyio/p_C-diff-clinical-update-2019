...
background-image: url(libs/figs/cdiff_txrec_clean.png)
...
background-image: url(libs/figs/cdiff_txrec_mark_initial.png)
background-size: contain
...
background-image: url(libs/figs/cdiff_txrec_mark_recurrent.png)
background-size: contain
